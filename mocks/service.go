...
func (_c *Service_OCSP_Call) Return(certificate *certs.Certificate, status int, issuerCert *x509.Certificate, err error) *Service_OCSP_Call {
	_c.Call.Return(certificate, status, issuerCert, err)
	return _c
}
